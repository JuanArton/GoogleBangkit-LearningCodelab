package com.juanarton.espressotest
...
class MainActivityTest {
    ...
    fun assertGetCircumference() {
        onView(withId(R.id.edt_length)).perform(typeText(12.0.toString()), closeSoftKeyboard())
        onView(withId(R.id.edt_width)).perform(typeText(17.0.toString()), closeSoftKeyboard())
        onView(withId(R.id.edt_height)).perform(typeText(6.0.toString()), closeSoftKeyboard())
